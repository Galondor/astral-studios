      ...
      <div className='App'>
        <div className='Container'>
          <div className='Release'>
            ...
            <p className='Countdown_text'>Release:</p>
          </div>
          <div className='Beta'>
            <h1 className='Countdown'>
              {remainingTime2.days} : {remainingTime2.hours} :{" "}
              {remainingTime2.minutes} : {remainingTime2.seconds}
            </h1>
            <p className='Countdown_text'>Closed Beta:</p>
          </div>
        </div>
        <div className='Codes'>
          <h1 className='code_Label'>Got Codes?</h1>
          <input
            className='Password'
            type='text'
            value={code}
